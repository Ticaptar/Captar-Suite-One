...
import type { ContratoSaidaInsumosListItem, ContratoStatus } from "@/lib/types/contrato";

type ListResponse = {
  items: ContratoSaidaInsumosListItem[];
  total: number;
  page: number;
  pageSize: number;
};
...
function tipoLabel(tipo: string): string {
  if (tipo === "saida_insumos") return "Saída de Insumos";
  return tipo;
}
