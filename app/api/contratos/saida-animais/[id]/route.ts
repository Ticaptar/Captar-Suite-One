...
import {
  getContratoSaidaAnimaisById,
  updateContratoSaidaAnimais,
} from "@/lib/repositories/contratos-saida-animais-repo";
...
export async function PATCH(request: Request, { params }: Params) {
  ...
  try {
    ...
    const updated = await updateContratoSaidaAnimais(contratoId, {
      empresaSap,
...
function parseOptionalDadosGerais(value: unknown) {
  ...
  return {
    ...
    compradorId: parseOptionalNullableString(dados.compradorId),
    compradorCodigo: parseOptionalNullableString(dados.compradorCodigo),
    compradorNome: parseOptionalNullableString(dados.compradorNome),
    compradorDocumento: parseOptionalNullableString(dados.compradorDocumento),
    faturadorId: parseOptionalNullableString(dados.faturadorId),
    faturadorCodigo: parseOptionalNullableString(dados.faturadorCodigo),
    faturadorNome: parseOptionalNullableString(dados.faturadorNome),
    faturadorDocumento: parseOptionalNullableString(dados.faturadorDocumento),
    frigorificoId: parseOptionalNullableString(dados.frigorificoId),
    frigorificoCodigo: parseOptionalNullableString(dados.frigorificoCodigo),
    frigorificoNome: parseOptionalNullableString(dados.frigorificoNome),
    frigorificoDocumento: parseOptionalNullableString(dados.frigorificoDocumento),
    anuenteId: parseOptionalNullableString(dados.anuenteId),
    anuenteCodigo: parseOptionalNullableString(dados.anuenteCodigo),
    anuenteNome: parseOptionalNullableString(dados.anuenteNome),
    anuenteDocumento: parseOptionalNullableString(dados.anuenteDocumento),
    sexo: parseOptionalNullableString(dados.sexo),
    valorArroba: parseOptionalNumber(dados.valorArroba) ?? null,
    rcFixo: parseOptionalNumber(dados.rcFixo) ?? null,
    dataEmbarque: parseOptionalNullableString(dados.dataEmbarque),
    dataPesagem: parseOptionalNullableString(dados.dataPesagem),
    dataAbate: parseOptionalNullableString(dados.dataAbate),
    tipoSaida: parseOptionalNullableString(dados.tipoSaida),
    ...
    lotes: parseOptionalCollectionRows(dados.lotes) ?? null,
    gtaContratos: parseOptionalCollectionRows(dados.gtaContratos) ?? null,
    abates: parseOptionalCollectionRows(dados.abates) ?? null,
  };
}
