...
import {
  createContratoSaidaAnimais,
  listContratosSaidaAnimais,
...
export async function GET(request: Request) {
  ...
  try {
    const data = await listContratosSaidaAnimais({
      status,
      exercicio,
      search,
      page,
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const created = await createContratoSaidaAnimais({
      empresaId,
      empresaSap,
...
function parseDadosGerais(value: unknown) {
  ...
  return {
    ...
    compradorId: toOptionalString(dados.compradorId),
    compradorCodigo: toOptionalString(dados.compradorCodigo),
    compradorNome: toOptionalString(dados.compradorNome),
    compradorDocumento: toOptionalString(dados.compradorDocumento),
    faturadorId: toOptionalString(dados.faturadorId),
    faturadorCodigo: toOptionalString(dados.faturadorCodigo),
    faturadorNome: toOptionalString(dados.faturadorNome),
    faturadorDocumento: toOptionalString(dados.faturadorDocumento),
    frigorificoId: toOptionalString(dados.frigorificoId),
    frigorificoCodigo: toOptionalString(dados.frigorificoCodigo),
    frigorificoNome: toOptionalString(dados.frigorificoNome),
    frigorificoDocumento: toOptionalString(dados.frigorificoDocumento),
    anuenteId: toOptionalString(dados.anuenteId),
    anuenteCodigo: toOptionalString(dados.anuenteCodigo),
    anuenteNome: toOptionalString(dados.anuenteNome),
    anuenteDocumento: toOptionalString(dados.anuenteDocumento),
    ...
    dataEmbarque: toOptionalString(dados.dataEmbarque),
    dataPesagem: toOptionalString(dados.dataPesagem),
    dataAbate: toOptionalString(dados.dataAbate),
    tipoSaida: toOptionalString(dados.tipoSaida),
    ...
    lotes: parseCollectionRows(dados.lotes) ?? null,
    gtaContratos: parseCollectionRows(dados.gtaContratos) ?? null,
    abates: parseCollectionRows(dados.abates) ?? null,
  };
}
